  ...
  return (
    <div className="site-shell">
      ...
      <main>
        ...
        <section className="cta-band" id="contact"><div><p className="kicker">Work With Jared</p><h2>NEED HELP WITH A PROPERTY DECISION?</h2><p>Send Jared the location, property type, budget or asking price, size requirement, and your timeline. He can help sort what matters first and what to inspect next.</p><div className="contact-details" aria-label="Jared contact details"><a href="tel:+60122971898">012-297 1898</a><a href="mailto:jaredwong.wg@gmail.com">jaredwong.wg@gmail.com</a><a href={facebookUrl} target="_blank" rel="noreferrer">Facebook</a><a href={instagramUrl} target="_blank" rel="noreferrer">Instagram</a></div></div><div className="contact-actions"><a href="https://wa.me/60122971898" aria-label="WhatsApp Jared at 012-297 1898">WHATSAPP JARED</a><a href="mailto:jaredwong.wg@gmail.com" aria-label="Email Jared">EMAIL JARED</a><a href={facebookUrl} target="_blank" rel="noreferrer" aria-label="Open Jared Wong Facebook">FACEBOOK</a><a href={instagramUrl} target="_blank" rel="noreferrer" aria-label="Open Jared Wong Instagram">INSTAGRAM</a></div></section>
      </main>
      <footer className="footer"><span>JARED WONG</span><p>Malaysia industrial and commercial property guidance for factories, warehouses, industrial land, shop lots, commercial units, leasing, sales, acquisition, and advisory. Contact Jared at 012-297 1898, jaredwong.wg@gmail.com, Facebook, or Instagram.</p></footer>
    </div>
  );
}
